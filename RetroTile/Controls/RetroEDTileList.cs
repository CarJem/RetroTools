...
namespace RetroTile.Controls
{
    ...
    public partial class RetroEDTileList : UserControl
    {
        ...
        public System.Windows.Forms.VScrollBar vScrollBar1
        {
            get
            {
                return vScrollBar1Old;
            }
            set
            {
                vScrollBar1Old = value;
            }
        }
        public System.Windows.Controls.Primitives.ScrollBar vScrollBarWPF;
		...
		private void SetupHostScrollBar()
		{
            ...
            this.vScrollBarWPF = new System.Windows.Controls.Primitives.ScrollBar();


            this.vScrollBarWPF.Width = 15;
            this.vScrollBarWPF.Orientation = System.Windows.Controls.Orientation.Vertical;
            this.vScrollBarWPF.Margin = new System.Windows.Thickness(0,0,0,0);
			...
			this.elementHost1.Child = this.vScrollBarWPF;

            vScrollBarWPF.Scroll += vScrollBar1_Scroll;
        }
        ...
        public void ChangeSize()
        {
            try
            {
                if (hScrollBar1 != null && vScrollBar1Old != null)
                {
                    switch (Direction)
                    {
            ...
            void WPF_Specifics()
            {
                if (vScrollBarWPF != null)
                {
                    vScrollBarWPF.ViewportSize = this.Height;
                    if (vScrollBarWPF.Track != null) vScrollBarWPF.Track.Thumb.Height = (this.Height / (vScrollBarWPF.Maximum - vScrollBarWPF.Maximum + vScrollBarWPF.ViewportSize)) * vScrollBarWPF.Track.ViewportSize;
                }
